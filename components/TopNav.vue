    ...
    <nav class="nav max-w-6xl mx-auto px-2 xl:px-0">
      <div class="nav-branding-wrapper">
        ...
        <div class="nav-web-name-wrapper">
          ...
          <div class="nav-explore-wrapper" @click.prevent="openExplore">
      ...
      <ul class="nav-list-wrapper-lv1">
        ...
        >
          ...
          >
            <span class="nav-item-name-lv1">{{ item_lv1.name }}</span>
            <i
          ...
          <input
            ...
            name="rad"
          />
          <ul v-if="hasChildren(item_lv1)" class="nav-list-wrapper-lv2">
            <li
            ...
            >
              <span class="nav-item-name-lv2">{{ item_lv2.name }}</span>
            </li>
          </ul>
        </li>
      </ul>
  ...
  methods: {
    ...
    setMenu() {
      if (this.$route.params.slug !== 'admin' && this.$route.params.slug) {
        this.menu = this.entries.find((item) => item.name === 'Menu xã').content
      } else {
