    ...
    <HomeService>
      <template #category>
        <HomeHeaderCategory
          ...
          @update="updateEntry"
          @viewAll="$router.push({ path: '/knowledge-library/list' })"
        />
      </template>
          ...
          <div
            ...
            @click="
              $router.push({
                ...
                query: { category: entry?.category_id, type: 1 },
              })
            "
          >
            <div class="h-[140px] sm:h-[160px] md:h-[200px] xl:h-[260px] mb-4">
              <img
                loading="lazy"
                alt="Hình ảnh"
            ...
            <div>
              ...
              <div class="text-[14px] text-[#737373]">
                {{ $filters.dateTime(entry?.created_at, 'HH:mm DD/MM/YYYY') }}
              </div>
              <div
